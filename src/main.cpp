...
void loop() {
  ...
  // Optimización: Solo actualizar pantalla si hay cambios
...
void runManualLogic() {
  ...
  if (elapsed >= timerDuration) { // USAR fanTimerStart
    ...
    // Actualizar pantalla si cambia el minuto
