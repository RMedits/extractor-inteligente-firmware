...
void loop() {
  ...
  // -- LECTURA DE SENSORES (THROTTLED 2000ms) --
  // Optimization: Decouple sensor reading from UI loop (200ms -> 2000ms)
  // This prevents I2C blocking from affecting display responsiveness
